      ...
      <ol role="list" class="flex items-center space-x-4">
        ...
        <li>
          <div class="flex items-center">
            ...
            <a href="{{ route('products') }}" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Products</a>
          </div>
        </li>
        <li>
          <div class="flex items-center">
            ...
            <span class="ml-4 text-sm font-medium text-gray-400" aria-current="page">{{ $product->name }}</span>
          </div>
        </li>
      </ol>
    </nav>
      ...
      <div class="flex flex-col-reverse">
          ...
          <div class="grid grid-cols-4 gap-6" aria-orientation="horizontal" role="tablist">
            <button id="tabs-1-tab-1" class="relative flex h-24 cursor-pointer items-center justify-center rounded-md bg-white text-sm font-medium text-gray-900 uppercase hover:bg-gray-50 focus:ring-3 focus:ring-indigo-500/50 focus:ring-offset-4 focus:outline-hidden" aria-controls="tabs-1-panel-1" role="tab" type="button">
              ...
              <span class="absolute inset-0 overflow-hidden rounded-md">
                <img src="https://tailwindcss.com/plus-assets/img/ecommerce-images/product-page-03-product-01.jpg" alt="" class="size-full object-cover" />
              </span>
        ...
        <div>
          ...
          <div id="tabs-1-panel-1" aria-labelledby="tabs-1-tab-1" role="tabpanel" tabindex="0">
            <img src="https://tailwindcss.com/plus-assets/img/ecommerce-images/product-page-03-product-01.jpg" alt="Angled front view with bag zipped and handles upright." class="aspect-square w-full object-cover sm:rounded-lg" />
          </div>
            ...
            <fieldset aria-label="Choose a color" class="mt-2">
              <div class="flex items-center gap-x-3">
                <div class="flex rounded-full outline -outline-offset-1 outline-black/10">
                  <input aria-label="Washed Black" type="radio" name="color" value="washed-black" checked class="size-8 appearance-none rounded-full bg-gray-700 forced-color-adjust-none checked:outline-2 checked:outline-offset-2 checked:outline-gray-700 focus-visible:outline-3 focus-visible:outline-offset-3" />
                </div>
                <div class="flex rounded-full outline -outline-offset-1 outline-black/10">
                  <input aria-label="White" type="radio" name="color" value="white" class="size-8 appearance-none rounded-full bg-white forced-color-adjust-none checked:outline-2 checked:outline-offset-2 checked:outline-gray-400 focus-visible:outline-3 focus-visible:outline-offset-3" />
                </div>
                <div class="flex rounded-full outline -outline-offset-1 outline-black/10">
                  <input aria-label="Washed Gray" type="radio" name="color" value="washed-gray" class="size-8 appearance-none rounded-full bg-gray-500 forced-color-adjust-none checked:outline-2 checked:outline-offset-2 checked:outline-gray-500 focus-visible:outline-3 focus-visible:outline-offset-3" />
                </div>
              </div>
            </fieldset>
          </div>
